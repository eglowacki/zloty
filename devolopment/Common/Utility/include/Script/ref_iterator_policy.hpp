...
// #include "ref_iterator_policy.hpp"

#ifndef LUABIND_REF_ITERATOR_POLICY__071111_HPP
# define LUABIND_REF_ITERATOR_POLICY__071111_HPP
...
struct iterator
{
    static int next(lua_State* L)
    {
        ...
        {
            convert_to_lua(L, boost::ref(*self->first));
            ++self->first;
        }
        else
        {
...
LUABIND_ANONYMOUS_FIX detail::policy_cons<
    detail::iterator_policy, detail::null_type> return_ref_stl_iterator;

}} // namespace luabind::unnamed

#endif // LUABIND_REF_ITERATOR_POLICY__071111_HPP
