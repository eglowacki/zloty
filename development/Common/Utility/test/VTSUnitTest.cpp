...
TEST(VTSSection)
{
    ...
    CHECK_EQUAL(section.Name, "TestSource");
    CHECK_EQUAL(section.Filter, "Attach/foo.txt");
    CHECK(section.Match == Section::FilterMatch::Like);
    CHECK_EQUAL("TestSource@Attach/foo.txt", section.ToString());

    section = Section("=TestSource@Attach/foo.txt");
    CHECK_EQUAL(section.Name, "TestSource");
    CHECK_EQUAL(section.Filter, "Attach/foo.txt");
    CHECK(section.Match == Section::FilterMatch::Exact);
    CHECK_EQUAL("=TestSource@Attach/foo.txt", section.ToString());

    section = Section(">TestSource@Attach/foo.txt");
    CHECK_EQUAL(section.Name, "TestSource");
    CHECK_EQUAL(section.Filter, "Attach/foo.txt");
    CHECK(section.Match == Section::FilterMatch::Override);
    CHECK_EQUAL(">TestSource@Attach/foo.txt", section.ToString());

    section = Section("TestSource@");
    CHECK_EQUAL(section.Name, "TestSource");
    CHECK_EQUAL(section.Filter, "");
    CHECK(section.Match == Section::FilterMatch::Like);
    CHECK_EQUAL("TestSource", section.ToString());
    ...
    section = Section("@TestSource");
    CHECK_EQUAL(section.Name, "");
    CHECK_EQUAL(section.Filter, "");
    CHECK(section.Match == Section::FilterMatch::Like);
    CHECK_EQUAL("", section.ToString());
    ...
    CHECK_EQUAL(intialSection.ToString(), newSection.ToString());
