...
extern void Prof_draw_console(float sx, float sy,
                              float width, float height,
                              float line_spacing,
                              int precision);
...
extern void Prof_draw_graph_dx(float sx, float sy, float x_spacing, float y_spacing, int resX, int resY);
